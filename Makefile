...
ifeq ($(GITHUB_PAGES), true)
	jekyll serve --port $(SERVE_PORT) --host $(SERVE_HOST) --config _config.yml
else
	jekyll serve --port $(SERVE_PORT) --host $(SERVE_HOST) --config "_config.yml,_config.local.yml"
endif
